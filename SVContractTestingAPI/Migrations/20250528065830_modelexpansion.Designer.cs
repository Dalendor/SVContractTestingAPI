...
namespace SVContractTestingAPI.Migrations
{
    ...
    [Migration("20250528065830_modelexpansion")]
            ...
            modelBuilder.Entity("SVContractTestingAPI.Models.Certificate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExpiryDate = new DateTime(2026, 5, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2969),
                            FamilyId = 1,
                            IssueDate = new DateTime(2024, 5, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2966),
                            Title = "Voedselattest"
                        },
                        new
                        {
                            Id = 2,
                            ExpiryDate = new DateTime(2026, 5, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2976),
                            FamilyId = 1,
                            IssueDate = new DateTime(2024, 5, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2974),
                            Title = "Pamperattest"
                        },
                        new
                        {
                            Id = 3,
                            ExpiryDate = new DateTime(2026, 5, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2979),
                            FamilyId = 2,
                            IssueDate = new DateTime(2024, 5, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2978),
                            Title = "Voedselattest"
                        });
                });
            ...
            modelBuilder.Entity("SVContractTestingAPI.Models.FoodProduct", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExpiryDate = new DateTime(2025, 11, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2810),
                            Name = "Pasta",
                            Quantity = 50
                        },
                        new
                        {
                            Id = 2,
                            ExpiryDate = new DateTime(2026, 5, 28, 8, 58, 30, 416, DateTimeKind.Local).AddTicks(2876),
                            Name = "Conservenbonen",
                            Quantity = 30
                        });
                });
